...
CREATE TABLE IF NOT EXISTS `pineapple_admin`(
   ...
   `uuid` CHAR(255) NOT NULL DEFAULT '' COMMENT 'uuid',
...
CREATE TABLE IF NOT EXISTS `pineapple_product`(
   ...
   `category_id`  CHAR(255) NOT NULL DEFAULT '' COMMENT '类别uuid',
   `created_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `pineapple_product_item`(
   ...
   `productuuid` CHAR(255) NOT NULL DEFAULT '' COMMENT '商品uuid',
   `created_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
   `updated_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
   `deleted_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '删除时间'
)ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE IF NOT EXISTS `pineapple_product_item_specifications`(
   ...
   `specificationsuuid` CHAR(255) NOT NULL DEFAULT '' COMMENT '规格uuid',
   `specificationspuuid` CHAR(255) NOT NULL DEFAULT '' COMMENT '规格父类puuid',
   `productitemuuid` CHAR(255) NOT NULL DEFAULT '' COMMENT '商品规格uuid',
   `created_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
   `updated_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
   `deleted_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '删除时间'
)ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE IF NOT EXISTS `pineapple_product_category_specifications` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
  `uuid` CHAR(255) NOT NULL DEFAULT '' COMMENT 'uuid',
  `categoryuuid` char(255) NOT NULL DEFAULT '' COMMENT '类别id',
  `specificationsuuid` char(255) NOT NULL DEFAULT '' COMMENT '规格id',
  `created_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建时间',
  `updated_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '修改时间',
  `deleted_at` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '删除时间'
...
CREATE TABLE IF NOT EXISTS `pineapple_carousel`(
    ...
    `target_uuid` CHAR(255) NOT NULL DEFAULT '0' COMMENT '目标外键',
