...
const TableList: React.FC<tableProps> = ({ dispatch, recommendList }) => {
          ...
          <a
            onClick={() =>
              Modal.confirm({
                ...
                onOk: () =>
                  dispatch({
                    type: 'recommendList/delete',
                    payload: record.questionId,
                  }),
              })
            }
          >
...
export default connect(({ recommendList }: { recommendList: StateType }) => ({
  recommendList,
}))(TableList);
